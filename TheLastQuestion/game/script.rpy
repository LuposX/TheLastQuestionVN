...
label start:
    ...
    He had a trick of doing that when he wanted to be contrary, 
    and he wanted to be contrary now, partly because he had had to carry the 
    ice and glassware. 'Not forever,' he said."
    ...
    that some was still left and sipped gently at his own drink. 
    ...
    and it can go to Pluto and back a million times without ever worrying about fuel. 
    ...
    "'Who says it didn't? What I say is that a sun won't last forever. 
    That's all I'm saying. We're safe for ten billion years, but then what?' 
    Lupow pointed a slightly shaky finger at the other. 
    'And don't say we'll switch to another sun.'"

    "There was silence for a while. Adell put his glass to his lips only occasionally, 
    and Lupov's eyes slowly closed. They rested."
    ...
    "'I get it,' said Adell. 
    'Don't shout. When the sun is done, the other stars will be gone, too'"
    ...
    You said we had all the energy we needed, forever. You said 'forever.''"
